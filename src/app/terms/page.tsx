export default function TermsPage() {
 ...
 <div className="max-w-3xl mx-auto bg-white rounded-[20px] border border-zinc-200/60 p-8 shadow-sm">
  ...
  <div className="text-xs text-zinc-400 mt-1 leading-relaxed">OrbitDesk teaches technical oversight, team coordination, service delivery and quality improvement through fictional scenarios. It does not certify job readiness or replace vendor training.</div>
  </div>
  </div>
