  ...
  const strategies = {
    visibility: {
      ...
      issues: [
        ...
        { problem: 'No landing page that converts', fix: 'LandingPage with hero, features, web vs app, install flow, social links — human not robotic', impact: 'High', effort: 'In Progress' },
    ...
    <div className="space-y-4">
        ...
        {activeStrategy === 'visibility' && (
          <div className="mt-5 space-y-3">
            ...
            <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-violet-500/10 to-indigo-500/10 border border-violet-500/20">
              <p className="text-[12px] font-bold text-violet-300">✅ Fixed in v6.2 — Human, Not Robotic</p>
      ...
      <div className="p-4 rounded-2xl bg-[#0a0a0a] border border-zinc-800/60">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-[13px] text-white">OrbitDesk v6.2 — Human, Not Robotic • Perfect Feeling Every Spot</p>
