    ...
    <div className="bg-[#0a0a0a] rounded-2xl border border-zinc-800/60 overflow-hidden flex flex-col h-[700px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-[16px] text-white flex items-center gap-2">
                ...
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-500/15 text-emerald-300 border border-emerald-500/20">Live • Innovative</span>
      ...
      <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-4 space-y-3">
              <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
                <p className="text-[11px] font-bold tracking-widest text-zinc-500 uppercase">Class Progress — Innovative</p>
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-violet-500/10 to-indigo-500/10 border border-violet-500/20">
                <p className="text-[11px] font-bold text-violet-300">🚀 Innovative Features — Not Basic</p>
        ...
        {activeView === 'leaderboard' && (
          <div className="space-y-3">
            ...
            <div className="mt-4 p-3 rounded-xl bg-zinc-900 border border-zinc-800">
              <p className="text-[11px] font-bold tracking-widest text-zinc-500 uppercase">Full Leaderboard — Gamified • Human • Not Robotic</p>
        ...
        {activeView === 'export' && (
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800">
              <p className="text-[13px] font-bold text-zinc-100">Export Class Data — External • Innovative</p>
              <p className="text-[11px] text-zinc-500 mt-1">For LMS, Google Sheets, Discord, portfolio — not basic, real integrations</p>
              ...
              <p className="text-[10px] text-zinc-600 mt-3">Real: Influx trainers can monitor class progress externally via Sheets, CSV, JSON — innovative, not basic classroom</p>
            </div>
            <div className="p-4 rounded-xl bg-gradient-to-br from-violet-500/10 to-indigo-500/10 border border-violet-500/20">
              <p className="text-[13px] font-bold text-violet-300">🌐 External Integrations — Innovative</p>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/80 backdrop-blur-xl z-[150] flex items-center justify-center p-4">
            <motion.div initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }} className="bg-[#0a0a0a] rounded-[20px] border border-zinc-800 max-w-[440px] w-full p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-[16px] text-white">Create New Class — Innovative</h3>
              ...
              <div className="mt-5 space-y-4">
                ...
                <div className="p-3 rounded-xl bg-violet-500/5 border border-violet-500/20">
                  <p className="text-[11px] font-bold text-violet-300">What you get — Not basic classroom:</p>
                  <ul className="mt-2 space-y-1 text-[11px] text-violet-200/70">
                    ...
                    <li>• Export CSV/JSON/Google Sheets, Discord webhook, LMS LTI — external, innovative</li>
                  </ul>
                </div>
